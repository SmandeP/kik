...
// Possible states for zCHN send
enum ZerocoinSpendStatus {
    ZCHN_SPEND_OKAY = 0,                            // No error
    ZCHN_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZCHN_WALLET_LOCKED = 2,                         // Wallet was locked
    ZCHN_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZCHN_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZCHN_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZCHN_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZCHN_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZCHN_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZCHN_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZCHN_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZCHN_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZCHN_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZCHN_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZCHN_SPENT_USED_ZCHN = 14,                      // Coin has already been spend
    ZCHN_TX_TOO_LARGE = 15                          // The transaction is larger than the max tx size
};
...
public:
    ...
    */
    ...
    void setZChnAutoBackups(bool fEnabled)
    {
