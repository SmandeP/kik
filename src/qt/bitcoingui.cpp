                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Chronos Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Chronos address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chronos: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCHN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Chronos Core"), this);
    aboutAction->setStatusTip(tr("Show information about Chronos Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Chronos"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Chronos addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Chronos addresses"));
    ...
    openAction->setStatusTip(tr("Open a Chronos: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Chronos Core help message to get a list with possible Chronos command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Chronos Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Chronos Core"); // default title
