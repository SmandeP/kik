...
#   c) node1 mines 32 blocks, so now node 0 has 60001chn, node 1 has 4250chn, node2 has none.
#   d) node0 sends 601 chn to node2, in two transactions (301 chn, then 300 chn).
