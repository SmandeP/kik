...
* WebSocket: [https://github.com/chronosproject/insight-api-chronos#web-socket-api](https://github.com/chronosproject/insight-api-chronos#web-socket-api) 
* API: [https://github.com/chronosproject/insight-api-chronos#swifttx-transactions](https://github.com/chronosproject/insight-api-chronos#swifttx-transactions) 
...
By default, the Chronos Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Chronos Core daemon:
