...
4.  (Optional) You can also install chronosd to your path:
...
* Database errors have been seen in builds on High Sierra. One solution is to build Berkeley DB from source.
        ...
        Then configure Chronos with this build of BerkeleyDB,
...
The use homebrew to install a number of unix programs and libraries needed to build the Chronos wallet:
...
You have the choice to build the GUI Chronos wallet as a Mac OSX app, described in “How to build the Chronos-Qt App”. If, for whatever reason, you prefer to use the command line tools, continue with “Command line tools”.

### How to build the Chronos-Qt App:

After make is finished, you can create an App bundle inside a disk image with:

```make deploy```

Once this is done, you’ll find Chronos-Qt.dmg inside your Chronos folder. Open and install the wallet like any typical Mac app.
...
~/Downloads/Chronos/src/qt/chronos-qt